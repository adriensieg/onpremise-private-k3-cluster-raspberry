...
SYSTEM_INSTRUCTION = (
    ...
    "- Ask them to click the red 'Manager' button in the upper-left corner of the POS.\n"
    "- Have them log in with Username: '1' and Password: '2'.\n"
    "- Instruct them to select 'Login Cashier DT'.\n"
    "- Then have them select the 'Order Taker' role.\n"
    "- When prompted, have them enter the employee Timecard Number: '1'.\n"
    "- After authentication is complete, verify that they can accept and process "
